...
import {  getCreator , getupcomingPayment , makePayment  , getpaymentHistory , getsalesDashboard ,
     updateComissionPercentage  , getLastTransactionDate , updateBankverification  } from "../../db/KhambeeQueries/creatorProfileQuery.js"
...
router.get("/",async (req,res)=>{
    ...
    try {
        const creator = await getCreator(creator_id)
        const success = {
            responseCode : 1 ,
